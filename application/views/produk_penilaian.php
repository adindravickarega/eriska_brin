			...
			<div class="row">
			  ...
			  <div class="card card-info">
					  ...
					  <div class="card-body">
							...
							<?php } ?>
							<td>
							<a class="btn btn-info btn-sm" href="<?php echo base_url().'penilaian_produk/penilaian/'.$p->id.'/'.$r->id.'/edit/'.$s->id;?>">
	  ...
	  if (result.isConfirmed) {
		Swal.fire(
		  ...
		  'success'
			...
			setTimeout(() => { window.location.href = "<?php echo base_url().'penilaian_produk/combine';?>"; }, 2000);
	  }
	})
}
</script>
