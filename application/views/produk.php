		...
		<div class="container-fluid">
			<div class="row">
			  ...
			  <div class="card card-info">
					  ...
					  <div class="row">
						<div class="col-md-4">
						<h3 class="card-title">Identifikasi Produk</h3>
						</div>
						<div class="col-md-4">
					  ...
					  <div class="card-body">
							...
							<td>
							<a class="btn btn-primary btn-sm" href="<?php echo base_url().'produk/view/'.$ir->id;?>">
							<i class="fas fa-folder">
							</i>
							View
							</a>
							<a class="btn btn-info btn-sm" href="<?php echo base_url().'produk/edit/'.$ir->id;?>">
							<i class="fas fa-pencil-alt">
							</i>
							Edit
							</a>
							<?php if($level == 'manajemen'){ ?>
							<a class="btn btn-warning btn-sm" href="<?php echo base_url().'produk/pembobotan_sod/'.$ir->id;?>">
							<i class="fas fa-tachometer-alt">
							</i>
							Weight
							</a>
							<?php } ?>
							<a class="btn btn-success btn-sm" href="<?php echo base_url().'produk/penilai_produk/'.$ir->id;?>">
				...
				<h4 class="modal-title">Identifikasi Risiko: Produk</h4>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="judul" placeholder="Nama Produk" maxlength="100" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<textarea class="form-control" rows="5" placeholder="Spesifikasi Produk ..." id="langkah" maxlength="100" required></textarea>
				</div>
				</div>
