			...
			<div class="row">
			  ...
			  <div class="card card-info">
					  ...
					  <div class="card-body">
							...
							<?php if($p->id == $r->id_proses && $s->id_risiko_proses == $r->id && ($s->keterangan == "Hindari" || $s->keterangan == "Mitigasi")){ ?>
							<tr>
							<td><?php echo $p->id;?></td>
					  ...
					  <div class="card-footer">
						  <a type="submit" class="btn btn-info" href="<?php echo base_url().'penilaian_proses/evaluasi/resume';?>">Resume</a>
					  </div>
					</div>
