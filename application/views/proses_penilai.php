  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Penunjukan Tim Penilai Risiko Proses</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
		...
		<div class="container-fluid">
			<div class="row">
			  ...
			  <div class="card card-info">
					  ...
					  <div class="row">
						<div class="col-md-4">
						<h3 class="card-title">Tim Penilai Proses</h3>
						</div>
						<div class="col-md-4">
...
function penilai(){
	var id_proses, penilai, jumlah_penilai, penilai_cek, nilai;
	...
	request.open('POST', "<?php echo base_url().'home/simpan_penilai_proses'?>", true);
	request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	request.send("id_proses=" + id_proses + "&penilai=" + nilai);
	Swal.fire(
	  'Berhasil!',
