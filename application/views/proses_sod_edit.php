...
function simpan(){
			var id_proses, id_sod_proses, id_risiko_proses, dampak, penyebab, metode_deteksi;
			...
			if(id_sod_proses != '' && id_risiko_proses != '' && dampak != '' && penyebab != '' && metode_deteksi != ''){
				...
				request.open('POST', "<?php echo base_url().'home/edit_sod_proses'?>", true);
				request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
				request.send("id_sod_proses=" + id_sod_proses + "&id_risiko_proses=" + id_risiko_proses + "&id_proses=" + id_proses + "&dampak=" + dampak + "&penyebab=" + penyebab + "&metode_deteksi=" + metode_deteksi);
			}
		}
function back(){
