		...
		<div class="container-fluid">
			<div class="row">
			  ...
			  <div class="card card-info">
					  ...
					  <div class="row">
						<div class="col-md-4">
						<h3 class="card-title">Evaluasi Risiko: Proses</h3>
						</div>
						<div class="col-md-4">
					  ...
					  <div class="card-body">
							...
							<a class="btn btn-warning btn-sm" href="<?php echo base_url().'proses/risiko/'.$p->id.'/'.$r->id.'/sod/mitigasi/'.$s->id;?>">
							<i class="fas fa-recycle">
							</i>
							Mitigate
							</a>
							<?php } ?>
							<a class="btn btn-info btn-sm" href="<?php echo base_url().'penilaian_proses/evaluasi/'.$p->id.'/'.$r->id.'/edit/'.$s->id;?>">
	  ...
	  if (result.isConfirmed) {
		Swal.fire(
		  ...
		  'success'
			...
			setTimeout(() => { window.location.href = "<?php echo base_url().'penilaian_proses/evaluasi/combine';?>"; }, 2000);
	  }
	})
}
</script>
