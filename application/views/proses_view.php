			...
			<div class="row">
			  ...
			  <div class="card card-info">
					  ...
					  <div class="card-body">
							...
							<td>
							<a class="btn btn-primary btn-sm" href="<?php echo base_url().'proses/risiko/'.$r->id_proses.'/view/'.$r->id;?>">
							<i class="fas fa-folder">
							</i>
							View
							</a>
							<a class="btn btn-info btn-sm" href="<?php echo base_url().'proses/risiko/'.$r->id_proses.'/edit/'.$r->id;?>">
