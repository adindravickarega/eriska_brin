			...
			<div class="row">
				<div class="col-md-12">
					<div class="card card-info">
					  ...
					  <div class="card-body">
							<input type="text" class="form-control" id="id_dampak_produk" value="<?php echo $d->id; ?>" hidden>
...
function simpan(){
			var id_produk, id_dampak_produk, id_risiko_produk, dampak;
			id_produk = document.getElementById("id_produk").value;
			id_dampak_produk = document.getElementById("id_dampak_produk").value;
			id_risiko_produk = document.getElementById("id_risiko_produk").value;
			dampak = document.getElementById("dampak").value;
			
			if(id_dampak_produk != '' && id_risiko_produk != '' && dampak != ''){
				...
				request.open('POST', "<?php echo base_url().'home/edit_dampak_produk'?>", true);
				request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
				request.send("id_dampak_produk=" + id_dampak_produk + "&id_risiko_produk=" + id_risiko_produk + "&id_produk=" + id_produk + "&dampak=" + dampak);
			}
		}
function back(){
	var id_produk, id_dampak_produk, id_risiko_produk, dampak;
