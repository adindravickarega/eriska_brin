				...
				<div class="col-md-12">
					<div class="card card-info">
					  ...
					  <div class="card-body">
							...
							<p><b>Usulan Tindakan: <?php echo $s->usulan_tindakan;?></b></p>
							<p><b>Penanggung Jawab: <?php echo $s->penanggung_jawab;?></b></p>
							<p><b>Tanggal Target: <?php echo $s->tanggal_target;?></b></p>
							<p><b>Tindakan Perbaikan: <?php echo $s->tindakan_perbaikan;?></td>
...
function simpan(){
			...
			if(id_proses != '' && id_risiko_proses != '' && id_sod_proses != '' && sd != '' && sd > 0 && sd < 11 && sp != '' && sp > 0 && sp < 11 && smd != '' && smd > 0 && smd < 11){
				...
				request.open('POST', "<?php echo base_url().'home/edit_evaluasi_proses'?>", true);
...
function back(){
	window.location.href = "<?php echo base_url().'penilaian_proses/evaluasi/'?>";
}
</script>
