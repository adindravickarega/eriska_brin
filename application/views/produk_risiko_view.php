        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>">Home</a></li><li class="breadcrumb-item"><a href="<?php echo base_url().'produk'?>">Produk</a></li><li class="breadcrumb-item"><a href="<?php echo base_url().'produk/view/'.$ir->id?>">Risiko</a></li>
            </ol>
          </div><!-- /.col -->
		  <?php } ?>
		  <div class="col-sm-12">
			...
			<div class="row">
			  ...
			  <div class="card card-info">
					  ...
					  <div class="card-body">
							...
							<td>
							<a class="btn btn-sm" style="color: white; background-color: #ee5bf5" href="<?php echo base_url().'produk/risiko/'.$ir->id.'/'.$r->id.'/sod/edit/'.$s->id;?>">
...
function simpan(){
			...
			if(dampak != '' && penyebab != '' && metode_deteksi != ''){
				...
				request.open('POST', "<?php echo base_url().'home/add_produk_sod'?>", true);
				request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
				request.send("id_risiko_produk=" + id_risiko_produk + "&dampak=" + dampak + "&penyebab=" + penyebab + "&metode_deteksi=" + metode_deteksi);
			}
		}
var ke;
function hapus(ke){
	Swal.fire({
	  ...
	  if (result.isConfirmed) {
		  var request = new XMLHttpRequest();
			...
			request.open('POST', "<?php echo base_url().'home/delete_produk_sod'?>", true);
			request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
